...
# If a sheet doesn't exist, openpyxl returns null. That's dumb. Raise.
...
# Also, load tex file here so the code will raise if something's amiss
...
def write_schedule_xlsx(professors, recruits, filepath):
    """
    Writes and saves a .xlsx spreadsheet containing two tabs - Professor
    Schedule and Recruit Schedule. Should be self explanatory.
    """
